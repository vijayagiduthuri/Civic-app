      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        <View className="px-5 space-y-6">
          ...
          <View>
            ...
            <View className="border border-gray-300 rounded-xl overflow-hidden" style={{ height: 250 }}>
              {isMapLoading ? (
            ...
            <View className="border border-gray-300 rounded-lg px-4 py-3 bg-gray-50">
              {locationDetails ? (
                <View className="space-y-2">
                  ...
                  <Text className="text-gray-700">
                    <Text className="font-medium">Coordinates:</Text> {locationDetails.latitude.toFixed(6)}, {locationDetails.longitude.toFixed(6)}
                  </Text>
                </View>
              ) : (
                <Text className="text-gray-700">
